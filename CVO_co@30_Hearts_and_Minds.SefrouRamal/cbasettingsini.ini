...
// CVO
CVO_CBA_musicDelayMin = 30;
CVO_CBA_musicDelayRandom = 300;
CVO_CBA_musicDisplay = true;
...
force tsp_cba_breach_lock_blacklist = "[""Land_BackAlley_01_l_gate_F""]";
tsp_cba_breach_lock_door = 0.75;
tsp_cba_breach_lock_house = 0.25;
...
WBK_BloodMod_HeadPart = true;
WBK_BloodMod_IMS = true;
WBK_BloodMod_Splatteronwals = true;
